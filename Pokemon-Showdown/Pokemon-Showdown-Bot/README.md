...
Web connectivity functionality was borrowed from the [Pokemon-Showdown-Node-Bot](https://github.com/Ecuacion/Pokemon-Showdown-Node-Bot) project. Special thanks to [Ecuacion](https://github.com/Ecuacion) for his work, which has allowed our AI bot to play against others users online.
...
This is a [Pokemon Showdown](https://github.com/Zarel/Pokemon-Showdown) bot written in Python and JavaScript for [Node](http://nodejs.org/)
